...
<head>
    ...
    <link rel="stylesheet" href="{{asset('layout/BackEnd/minimo.css')}}">
</head>
<body>
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{route('list_news')}}">
            ...
            <div class="col-lg-2">
                <ul class="list-group">
                    <li class="list-group-item">
                        <a href="{{route('list_news')}}">News</a>
                    </li>
                    <li class="list-group-item">
                        <a href="{{route('list_category')}}">Category</a>
                    </li>
                </ul>
            </div>
